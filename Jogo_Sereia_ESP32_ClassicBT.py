...
############### TELA ###############
largura_tela, altura_tela, tamanho, tempo = pygame.display.Info().current_w, \
...
print(type(bluetooth.SERIAL_PORT_PROFILE))
#print(bluetooth.BluetoothSocket.keys())
...
posimax, posimin, larg = 0, largura_tela, largura_tela - ((largura_tela % 100)%10) + altura_tela//9.6

############### DEFINIÇÃO DOS QUADRANTES ##########

larguras, alturas = zip(*[(largura_tela//36*i, altura_tela//36*i) for i in range(37)])
...
class coluna(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imagemcoluna = pygame.transform.scale(pygame.image.load('imagens/coluna.png'), (int(largura_tela/9), int(altura_tela/1.5)))
        self.imagemcoluna2 = pygame.transform.scale(pygame.image.load('imagens/coluna.png'), (int(largura_tela/9), int(altura_tela/1.5)))
    ...
    def show(self, tela, pos_x, pos_y):
            ...
            self.rect2.centerx , self.rect2.centery = int(pos_x), int(pos_y + (altura_tela//1.18)) #espaço de 150 entre as colunas

class preview(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.prev = pygame.transform.scale(pygame.movie.Movie("teste"), (int(largura_tela/5), int(altura_tela/5)))
...
class botao(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.imagembotao = pygame.transform.scale(pygame.image.load('imagens/bota.png'), (int(largura_tela//1.6), int(altura_tela//2.5)))
        self.imagembotao2 = pygame.transform.scale(pygame.image.load('imagens/bota.png'), (int(largura_tela//1.2), int(altura_tela//2.5)))
        self.imagembotao3 = pygame.transform.scale(pygame.image.load('imagens/bota_peq.png'), (int(largura_tela//7), int(altura_tela//7)))
        self.imagembotao4 = pygame.transform.scale(pygame.image.load('imagens/bota.png'), (int(largura_tela//4), int(altura_tela//2.5)))
...
class sereia(pygame.sprite.Sprite):
    def __init__(self):
        ...
        for i in range(len(filenames)):
            self.imgs[i] = pygame.transform.scale(self.imgs[i], (int(largura_tela/5.7), int(altura_tela/6.2)))
...
class letras(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imgs = [pygame.image.load(fn) for fn in filenames]
        self.imgs[1] = pygame.transform.scale(self.imgs[1], (int(largura_tela/1.6), int(altura_tela/3.5)))
        self.imgs[2] = pygame.transform.scale(self.imgs[2], (int(largura_tela//5), int(altura_tela//7)))
        self.imgs[-2] = pygame.transform.scale(self.imgs[-2], (int(largura_tela/4), int(altura_tela/6.5)))
...
class fundo(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imgs = [pygame.image.load(fn) for fn in filenames]
        for i in range(len(filenames)):
            self.imgs[i] = pygame.transform.scale(self.imgs[i], (int(largura_tela + 50), int(altura_tela + 50)))
        self.rects = [img.get_rect() for img in self.imgs]
...
class grafmmae(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.imagemmaxmin = pygame.transform.scale(pygame.image.load('make_plot/acerto_erro.png'), (int(largura_tela/3.5), int(largura_tela/4.8)))
        self.imagemacererro = pygame.transform.scale(pygame.image.load('make_plot/max_min.png'), (int(largura_tela/3.5), int(largura_tela/4.8)))
    ...
    def show(self, tela, pos_x, pos_y):
            ...
            self.rect2.centerx , self.rect2.centery = int(pos_x + (altura_tela*1.03)), int(pos_y) #espaço de 150 entre as colunas
...
class bubble (pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imgs = [pygame.image.load(fn) for fn in filenames]
        self.imgs[0] = pygame.transform.scale(self.imgs[0], (int(largura_tela/50), int(altura_tela/30)))
        self.imgs[1] = pygame.transform.scale(self.imgs[1], (int(largura_tela/100), int(altura_tela/80)))
        self.rects = [img.get_rect() for img in self.imgs]
        self.imagembolha, self.imagembolha2 = self.imgs

    def show(self, tela, pos_x, pos_y, nova):
        pos_x_v = [altura_tela//2, altura_tela//4,-(altura_tela//8),0,-altura_tela//2.6,-altura_tela//2, \
                   altura_tela//1.8,-(altura_tela//1.2),-(altura_tela//12),-altura_tela//10]

        pos_y_v = [altura_tela//17.5, altura_tela//70, altura_tela//5.3, altura_tela//13, altura_tela//20, \
                   altura_tela//6,(altura_tela//6),(altura_tela//12),altura_tela//10, altura_tela//5]
...
class fish (pygame.sprite.Sprite):
    def __init__(self):
        ...
        for i in range(0, len(filenames)):
            self.imgs[i] = pygame.transform.scale(self.imgs[i], (int(largura_tela/50), int(altura_tela/30)))
        self.rects = [img.get_rect() for img in self.imgs]
    ...
    def show(self, tela, pos_x, pos_y, nova, escolha):
        pos_x_v = [altura_tela//25.6, altura_tela//17, 0, altura_tela//5.12, altura_tela//2.56, \
                   altura_tela//8, altura_tela//12.8, altura_tela//3.6, altura_tela//2.13, 0]
        pos_y_v = [altura_tela//5.12, -altura_tela//5.12, altura_tela//5.12, -altura_tela//5.12, \
                   altura_tela//5.12, -altura_tela//5.12, altura_tela//5.12, -altura_tela//5.12, \
                   altura_tela//5.12, -altura_tela//5.12]
        if 0 < escolha <= 9:
            img, rect = self.imgs[escolha - 1], self.rects[escolha - 1]
            tela.blit(img, rect)
...
class letr(pygame.sprite.Sprite):
    def __init__(self):
        ...
        for i in range(0, len(filenames)):
            if i < 26:
                self.imgs[i] = pygame.transform.scale(self.imgs[i],(int(largura_tela/13), int(altura_tela/8)))
            else:
                 self.imgs[i] = pygame.transform.scale(self.imgs[i],(int(largura_tela/10), int(altura_tela/6)))
        self.imgs[4] = pygame.transform.scale(self.imgs[4],(int(largura_tela/13.5), int(altura_tela/8)))
        self.imgs[30] = pygame.transform.scale(self.imgs[30],(int(largura_tela/10.5), int(altura_tela/6)))
        self.imgs[52] = pygame.transform.scale(self.imgs[52],(int(largura_tela/8), int(altura_tela/7)))
        ...
        if tamanho == 0:
            for caracter in palavra:
                ...
                if caracter==' ':
                    ...
                    img, rect = self.imgs[escolha], self.rects[escolha]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/30), int(pos_y + 3)
                elif caracter==':':
                    img, rect = self.imgs[52], self.rects[52]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/30), int(pos_y - 1)
                else:
                    img, rect = self.imgs[escolha], self.rects[escolha]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/30), int(pos_y)
        else:
            for caracter in palavra:
                cont += 1
                ...
                if caracter==' ':
                    ...
                    img, rect = self.imgs[escolha], self.rects[escolha]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/23), int(pos_y + 3)
                elif caracter==':':
                    img, rect = self.imgs[52], self.rects[52]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/30), int(pos_y + 3)
                    ...
                    img, rect = self.imgs[escolha], self.rects[escolha]
                    tela.blit(img, rect)
                    rect.centerx, rect.centery = int(posicao(quad_x, quad_y,"x") + largura_tela*cont/23), int(pos_y)


class coral (pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.imagemcor1 = pygame.transform.scale(pygame.image.load('imagens/alga.png'), (int(largura_tela/7), int(altura_tela/5)))
...
def gameover(pont, temp, paciente, data, tratamento, id_temp, id_pont):
    ...
    inter = [(-100, largura_tela), (-100, largura_tela), (-100, largura_tela)]
    ...
    cor.show(tela, posicao(35, 9,"x")+largura_tela//36, posicao(35, 10,"y"), 1)
    cor.show(tela, posicao(0, 9,"x"), posicao(0, 10,"y"), 1)
    col.show(tela, posicao(35, 23,"x")+largura_tela//36, posicao(35, 24,"y"))
    ...
    while final:
        ...
        cor.show(tela, posicao(35, 9,"x") + largura_tela//36, posicao(35, 10,"y"), 1)
        cor.show(tela, posicao(0, 9,"x"), posicao(0, 10,"y"), 1)
        col.show(tela, posicao(35, 23,"x") + largura_tela//36, posicao(35, 23,"y"))
        col.show(tela, posicao(0, 23,"x"), posicao(0, 23,"y"))
        bot.show(tela, posicao(17, 17,"x") + altura_tela//45, posicao(posibot, posibot,"y"), 0)
        ...
        ################################
        if pos_buble_y == altura_tela:
            nova = randint(-300, 300)
            nova2 = randint(-300, 300)

        if pos_buble_y<-altura_tela*1.5:
            pos_buble_y = altura_tela-((altura_tela % 100)%10)
...
def modo():
    ...
    col.show(tela, posicao(35, 23,"x") + largura_tela//36, posicao(35, 24,"y"))
    col.show(tela, posicao(0, 23,"x"), posicao(0, 24,"y"))
    bot.show(tela, posicao(12, 12,"x") + altura_tela//45, posicao(11, posibotao[posibot],"y"), 1)
    bot.show(tela, posicao(18, 18,"x"), posicao(18, 5,"y") + altura_tela//240, 2)
    texto2.show(tela, posicao(18, 18,"x")+ largura_tela//80, posicao(18, 3,"y"), 3)
    for conta in range(10):
        dez.show(tela, posicao(18, 18,"x"), posicao(18, 5,"y"), conta)
        uni.show(tela, posicao(18, 18,"x") + largura_tela//50, posicao(18, 5,"y"), conta)
        fund.show(tela, posicao(18, 18, "x"), posicao(18, 18, "y"), 1)
    ...
    while mod:
        ...
        fund.show(tela, posicao(18, 18, "x"), posicao(18, 18,"y"), 1)
        cor.show(tela, posicao(35, 9,"x")+largura_tela//36 + move, posicao(35, 10,"y"), 1)
        cor.show(tela, posicao(0, 9,"x")+ move, posicao(0, 10,"y"), 1)
        col.show(tela, posicao(35, 23,"x")+largura_tela//36 + move, posicao(35, 24,"y"))
        ...
        if check == 0:
            bot.show(tela, posicao(12, 12,"x") + altura_tela//40, posicao(11, posibotao[posibot],"y"), 1)
        texto2.show(tela, posicao(18, 18,"x") + largura_tela//80 + move, posicao(18, 3,"y"), 3)
        if check == 1:
            bot.show(tela, posicao(18, 18,"x") + posibottem, posicao(18, 5,"y") + altura_tela//240, 2)
        dez.show(tela, posicao(18, 18,"x")+ move, posicao(18, 5,"y"), deze)
        uni.show(tela, posicao(18, 18,"x") + largura_tela//50 + move, posicao(18, 5,"y"), unid)
                    ...
                    if check == 0:
                        ...
                        if posibot < 0:
                            if rolagem == 0:
                                ...
                                rolagem = 0
                                posibot = 3
                    elif check == 1 and posibottem == largura_tela//50:
                        unid += 1
                        if unid > 9:
                            unid = 9
        ...
        if check == 2:
            ...
            if move > -largura_tela*1.4:
                move -= 10
                moveseri_x -= 10
                moveseri_y += 10
                if moveseri_x < -largura_tela//1.5:
                    moveseri_x += 10
                if moveseri_y > altura_tela//2:
                    moveseri_y -= 10
            else:
...
##                        pygame.mixer.music.stop()
        ...
        if check == 1:
            try:
                ...
                frame = cv2.resize(frame, (int(altura_tela/4), int(largura_tela/4)))
                preview_surface = pygame.surfarray.make_surface(frame)
                tela.blit(preview_surface, (int(2.7/4*largura_tela), int(altura_tela/4)))
            except:
...
def taragem():
    ...
    cont =  [letras()]*6 + [numeros()]*7 + [coluna(), coral(), sereia(),
             fundo(), bubble(), 700, 0, 720, 0, 0, 0, 0, altura_tela,
             True, 2, 121] #este valor 121 é escolhido para que a sereia fique mais ou menos no meio da tela
    ...
    posimax, posimin, tara, velocidade_y, dado_BT = [i for i in cont]
    ...
    cor.show(tela, posicao(35, 9,"x")+largura_tela//36, posicao(35, 10,"y"), 1)
    col.show(tela, posicao(35, 23,"x")+largura_tela//36, posicao(35, 24,"y"))
    ariel.show(tela, posicao(18, 18,"x"), altura_tela - posi, 0)
    ariel.show(tela, posicao(18, 18,"x"), altura_tela - posi, 1)
...
#####################
    ...
    while tara:
        ...
        while (contagem2 <= 10):
            ...
            if contagem2 == 0 and check == 0:
                for contagem in range(5, 0,-1):
                    ...
                    while time.time()-startcont < 1:
                        test.show(tela, 7, 12, "CONTRAIA O MAXIMO", 0)
                        test3.show(tela, 12, 14, "QUE PUDER", 0)
                        uni.show(tela, int(largura_tela/2), int(altura_tela/2), contagem)
                        pygame.display.update()
                ser.write(str.encode("i"))
                startcont = time.time()
                check = 1
            ...
            if (ser.inWaiting() > 0):
                dado_BT = int(ser.read(ser.inWaiting())) 
                print("dado_BT = ", dado_BT)
                if (dado_BT > 1000):
                    posi = dado_BT%1000
                else:
                    posi = dado_BT
                ...
                while (flag_transm == False and (altura_tela + 100 - 10*i > altura_tela - posi*2.5)):
                        ...
                        quant_loop = (altura_tela + 100 - 10)/(altura_tela - posi*2.5)
                        ...
                        ariel.show(tela, posicao(18, 18,"x"), altura_tela + 100 - 10*i, i%2)
                        i+=1
                        clock.tick(15)
                        pygame.display.update()
            ...
            if (pos_buble_y % 15)==0:
                ...
                escolha = 0
            if(flag_transm == True):
                #o parâmetro escolha fica alternando entre as duas imagens da sereia, pra dar o efeito de movimento
                ariel.show(tela, posicao(18, 18,"x"), altura_tela - posi*2.5, escolha)
            if posi > posimax:
                posimax = posi
        ...
        while (contagem3 <= 12):
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ser.write(str.encode("p"))
                    tara = False
            ariel.show(tela, posicao(18, 18,"x"), altura_tela - posi2*2, escolha)
            if posi2 < posimin:
                posimin = posi2
...
######################### FUNDO ###############################
        tela.fill(azul)
        fund1.show(tela, pos_xf, int(altura_tela//2), 1)
        fund2.show(tela, pos_xf2, int(altura_tela//2), 0)

        pos_xf = round(largura_tela*1.537)-1 if pos_xf2 == largura_tela//2 else pos_xf - 1
        pos_xf2 = round(largura_tela*1.537)-1 if pos_xf == largura_tela//2 else pos_xf2 -1


################### ALEATORIEDADE DAS BOLHAS ################
        if pos_buble_y == altura_tela:
            nova, nova2 = randint(-largura_tela//3, largura_tela//3), randint(-largura_tela//3, largura_tela//3)
        if pos_buble_y < -altura_tela*1.8:
            pos_buble_y = altura_tela*1.1
        #bolhas.show(tela, pos_buble_x, pos_buble_y, nova)
...
##################PEIXES
        ...
        if pos_peix_x == -largura_tela//13:
            aleatorio = [(-400, altura_tela//1.5), (-400, altura_tela//1.5), (1, 5), (1, 5)]
            novapeixe, novapeixe2, escolhapeixe, escolhapeixe2 = [randint(*pair) for pair in aleatorio]
        if pos_peix_x > largura_tela + largura_tela//7:
            pos_peix_x=-altura_tela//2
...
####### CONTROLE DE MOVIMENTOS DO OBSTÁCULO #################
        ...
        if cont <= 0:
            ...
            pos_obs_y[0] = int(altura_tela*(1/2 - pos_col_y[cont]))
        ...
        if  pos_obs_x[0]>3*(largura_tela//4)-velocidade_obs+(largura_tela//18) and pos_obs_x[0]<=3*(largura_tela//4)+(largura_tela//18)and cont <= len(pos_col_y)-2: # Distância de 1//4 da largura da tela entre obstáculos.
            cont += 1                                                                                        # Limite dos intervalos deve ser subtraído de
            pos_obs_x[1], pos_obs_y[1] = larg, altura_tela*(1/2 - pos_col_y[cont])                                  # 1//2 largura do obstáculo.

        if  pos_obs_x[0]>2*(largura_tela//4)-velocidade_obs+(largura_tela//18) and pos_obs_x[0]<=2*(largura_tela//4)+(largura_tela//18) and cont <= len(pos_col_y)-2:
            cont += 1
            pos_obs_x[2], pos_obs_y[2] = larg, altura_tela*(1/2 - pos_col_y[cont])

        if  pos_obs_x[0]>(largura_tela//4)-velocidade_obs+(largura_tela//18) and pos_obs_x[0]<=(largura_tela//4)+(largura_tela//18) and cont <= len(pos_col_y)-2:
            cont += 1
            pos_obs_x[3], pos_obs_y[3] = larg, altura_tela*(1/2 - pos_col_y[cont])

        if  pos_obs_x[0]>-velocidade_obs+(largura_tela//18) and pos_obs_x[0]<=0+(largura_tela//18) and cont <= len(pos_col_y)-2:
            cont += 1
            pos_obs_x[4], pos_obs_y[4] = larg, altura_tela*(1/2 - pos_col_y[cont])

        if  pos_obs_x[0]>-(largura_tela//4)-velocidade_obs+(largura_tela//18) and pos_obs_x[0]<=-(largura_tela//4)+(largura_tela//18) and cont <= len(pos_col_y)-2:
            cont += 1
            pos_obs_x[0], pos_obs_y[0] = larg, altura_tela*(1/2 - pos_col_y[cont])
...
##                print(total_colisoes)
        ...
        for i in range (5):
            if pos_x==(pos_obs_x[i]+(largura_tela//15.17)):
                pontos += 1
                recorde(pontos)
...
############### MÚSICA #####################################
        ...
        if sair == True:
            valor_mapeado = ((pos_y - 0) / (273 - 0)) * (20 - (altura_tela-20)) + (altura_tela-20)
            valor_mapeado = round(valor_mapeado)
            ariel.show(tela, pos_x, valor_mapeado, escolha)
